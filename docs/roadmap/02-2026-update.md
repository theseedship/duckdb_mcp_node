...
**Date**: 2026-02-21 (mise a jour: S2 termine)
...
| S2: Enrichir DuckPGQ (F1-F5) | HAUTE    | ~20h          | v0.12.0 | TERMINE  |
| S3: Bridge MCP SDK + HITL    | MOYENNE  | ~12h          | v0.13.0 | PROCHAIN |
...
**Resultat**: 8 outils MCP, 19 tests d'integration, publie en v0.12.0 (21 fev 2026).
...
Semaine 4   (fev 2026):   S2 F1-F5      — 8 graph tools en un seul sprint    ✅ FAIT (21 fev)
  → Release v0.12.0 (S2 complete)
Semaine 5-6 (mars 2026):  S3 Vague 1+2 — SDK alignment + HITL foundation     ⬜ PROCHAIN
Semaine 7   (mars 2026):  S3 Vague 3    — Tests + docs → Release v0.13.0
```
